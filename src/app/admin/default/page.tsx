...
const Dashboard = () => {
  ...
  const fetchData = async () => {
    try {
      const ridersResponse = await fetch("https://appgobabi.com/api/count-riders");
      const driversResponse = await fetch("https://appgobabi.com/api/count-drivers");
      const driversOnlinesResponse = await fetch("https://appgobabi.com/api/count-online-drivers");
      const driversOfflinesResponse = await fetch("https://appgobabi.com/api/count-offline-drivers");
      const driversByIdCodeResponse = await fetch("https://appgobabi.com/api/drivers-by-id-code");
      const oldVersionResponse = await fetch("https://appgobabi.com/api/count-old-version-drivers");
      const riderInProgressResponse = await fetch("https://appgobabi.com/api/rides/in-progress-today");
      ...
      setDriversByIdCode(driversByIdCodeData.drivers_with_null_id_code.count);
  ...
  useEffect(() => {
    if (riderInProgress !== previousRiderInProgress.current) {
      if (riderInProgress > previousRiderInProgress.current) {
        ...
        speak("Une nouvelle course vient d'être terminé");
      }
